...
' Start TeamViewer once
If OsType = "x86" Then
	'Wscript.Echo "System is x86"
	'objShell.Run "CMD /C CD /D C:\Program Files\TeamViewer\ & TeamViewer.exe"
End If
If OsType = "AMD64" Then
	'Wscript.Echo "System is AMD64"
	'objShell.Exec "CMD /C CD /D C:\Program Files (x86)\TeamViewer\ & TeamViewer.exe"
End If
'#########################################################################
'#########################################################################
